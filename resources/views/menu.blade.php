  ...
  <main id="main">
    ...
    <section id="menu" class="menu" style="margin-top:70px">
      <div class="container">
        ...
        <div class="section-title">
          <h2><img  src="{{ asset('/delicious/sticker/02.png') }}" width="10%"> Check our tasty <span>Menu</span></h2>
        </div>
    ...
    <section id="gallery" class="gallery">
      <div class="container-fluid">
        ...
        <div class="section-title">
          <h2><img  src="{{ asset('/delicious/sticker/13.png') }}" width="10%"> Some photos from <span>Our Bakery</span></h2>
        </div>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2><span>Contact</span> Us<img  src="{{ asset('/delicious/sticker/17.png') }}" width="10%"></h2>
          </div>
      </div>
